...
/**
 * unset_alias - set the alias to a string
...
/**
 * set_alias - set the alias to a string
 * @info: parameter struct
...
/**
 * _kshalias - mimics the alias builtin
 * @info: Structure containing potential arguments used to maintain
 * constant function prototype.
 *  Return: Always 0
 */
int _kshalias(info_t *info)
{
	int a = 0;
	char *p = NULL;
	list_t *node = NULL;
